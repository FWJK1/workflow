    ...
    \begin{columns}
        \begin{column}{.48\textwidth}
            \begin{itemize}
                ...
                \item \textbf{\textit{Better Pipelining}}
                \item \textbf{Fun!}
            \end{itemize}
        \end{column}
        \begin{column}{.48\textwidth}
...
\begin{frame}{Coding Practices}
    \begin{itemize}
        ...
        \item \textbf{Reproducibility}: if in python, use conda or at least a pip list.
        \item Make stuff so that you can use it in later projects!
        \item Tests, Types
        \item Doing everything like you want to get better at doing it.
    \end{itemize}
\end{frame}
...
\begin{frame}{Version Control: GIT}
    \begin{itemize}
        ...
        \item BAD: in proprietary github. GOOD: in VS code extension. BEST: in terminal
    \end{itemize}
\end{frame}
